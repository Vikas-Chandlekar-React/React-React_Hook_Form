  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit, onError)} noValidate>
        ...
        {/* POINT : Manually Trigger Validate for  Whole Form */}
        <button type="button" onClick={() => trigger()}>
          Manually Trigger Whole Form
        </button>

        <br />

        {/* POINT : Manually Trigger Validate for single field */}
        <button type="button" onClick={() => trigger("email")}>
          Manually Trigger Single Field
        </button>
      </form>
